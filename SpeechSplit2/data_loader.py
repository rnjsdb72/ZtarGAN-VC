...
class Utterances(data.Dataset):
    ...
    def __init__(self, config):
        ...
        self.feat_dir = config.directories.feat_dir
        self.wav_dir = os.path.join(self.feat_dir, config.directories.wav_dir)
        self.spmel_dir = os.path.join(self.feat_dir, config.directories.spmel_dir)
        self.f0_dir = os.path.join(self.feat_dir, config.directories.f0_dir)
        self.experiment = config.train.experiment
