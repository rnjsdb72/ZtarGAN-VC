...
class Solver(object):
    ...
    def __init__(self, train_loader, test_loader, num_speakers, config):
        ...
        self.lambda_id = config.model.lambda_id

        # Training configurations.
        self.batch_size = config.train.batch_size
        self.num_iters = config.train.num_iters
        self.num_iters_decay = config.train.num_iters_decay
        ...
        self.resume_iters = config.train.resume_iters

        # Test configurations.
        self.test_iters = config.test.test_iters

        # Miscellaneous.
        self.logger = SummaryWriter(log_dir=config.directories.log_dir)
        ...
        # Step size.
        self.log_step = config.step.log_step
        self.sample_step = config.step.sample_step
        self.model_save_step = config.step.model_save_step
        self.lr_update_step = config.step.lr_update_step
